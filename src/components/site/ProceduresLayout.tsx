      ...
      <SidebarProvider defaultOpen>
        <div className="flex w-full min-h-[calc(100vh-200px)]">
          ...
          <SidebarInset className="bg-background">
            ...
            <div className="sticky top-[calc(80px+44px)] lg:top-[calc(116px+44px)] z-20 flex items-center gap-3 border-b hairline bg-background/85 backdrop-blur-md px-4 lg:px-6 h-12">
