    ...
    <div className="editorial-container pt-16 lg:pt-20 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-2 text-sm text-background/80">
            <li><Link to="/studio" className="hover:text-gold transition-colors">Studio</Link></li>
            <li><Link to="/procedure" className="hover:text-gold transition-colors">Le procedure</Link></li>
